...
const Input1: NextPage<Input1Type> = ({ className = "" }) => {
  return (
    ...
    >
      <input
        className="w-[109px] [border:none] [outline:none] font-body-normal-regular text-base bg-[transparent] h-[26px] relative leading-[160%] text-neutrals-40 text-left inline-block p-0"
