...
const Sidebar: React.FC = () => {
  return (
    <aside className="flex flex-col w-[19%] h-[100vh] max-md:ml-0 max-md:w-full">
      <div className="flex flex-col justify-between py-8 mx-auto w-full h-full shadow-sm bg-slate-50">
        ...
        <div className="relative">
          <div className="absolute bottom-0 left-0 flex gap-4 items-center px-8 mb-4 max-w-full text-sm leading-relaxed text-gray-800 whitespace-nowrap w-[272px] max-md:px-5">
            <Image loading="lazy" src={jake} alt='' className="w-12 h-12 object-cover rounded-full" />
            <div className="flex flex-col">
              <div className="text-base font-medium">Jake Gyll</div>
              <div className="text-sm opacity-50">jakegyll@email.com</div>
            </div>
          </div>
        </div>
      </div>
