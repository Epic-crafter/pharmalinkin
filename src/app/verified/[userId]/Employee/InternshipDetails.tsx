...
const InternshipDetails= ({
  ...
  return (
    <div className="fixed  inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 overflow-y-auto">
      <div className="bg-white w-11/12 md:w-2/3 lg:w-[60%] rounded-lg shadow-lg p-6 max-h-full overflow-y-auto">
        {/* Modal Header */}
        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-3">
              {internship.skills.map((skill:any, index:any) => (
                <span
                  key={index}
          ...
          <div className="  rounded">
            ...
            <p className="text-gray-600 mb-3">{internship.additionalInfo}</p>
            <ul className="list-disc list-inside text-gray-600 space-y-1">
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-2">
              {internship.perks.map((perk:any, index:any) => (
                <span
                  key={index}
                  className="bg-gray-100 text-gray-700 px-3 py-1 rounded-full text-sm"
                >
          ...
          <div>
            ...
            <p className="text-gray-600">{internship.aboutCompany}</p>
          </div>
...
<div>
    ...
    <p className="flex items-center gap-1"><FaCalendarCheck/> Hiring since May 2020</p>
    <p className="flex items-center gap-1"><FaIdCard/> 537 opportunities posted</p>
    <p className="flex items-center gap-1"><FaUserCheck/> 60990 candidates hired</p>
    </div>
</div>
<hr className="border-gray-300" />
