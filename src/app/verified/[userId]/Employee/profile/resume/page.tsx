          ...
          <div className=" p-4 rounded-md shadow-md space-y-4">
            ...
            <div className="bg-white space-y-8">
              <div className="bg-white p-2 m-2">
                ...
                <p className="text-gray-500">This is CV / Resume document that you can update anytime</p>
              </div>
            ...
            <div className="flex justify-between items-start flex-col md:flex-row md:gap-4 sm:gap-2">
              ...
              <div className="lg:w-3/5 md:w-3/5 sm:w-full space-y-4">
                <div className='space-y-1'>
                  ...
                  <p className='text-gray-600 pl-2 m-2 text-sm'>Your CV / Resume is verified</p>
                </div>
                <div className='space-y-1'>
                  <div className=' '>
                    <p className='font-semibold pl-2 m-2'>Update CV / Resume Name</p>
            ...
            <div className="flex justify-between items-start flex-col md:flex-row md:gap-4 sm:gap-2">
              ...
              <div className="lg:w-3/5 md:w-3/5 sm:w-full space-y-4">
                <div>
                  <h2 className='font-semibold p-2 m-2'>Upload CV / Resume </h2>
                </div>
                ...
                <div className='lg:w-2/3 w-full flex justify-between'>
                  <button className=' px-4 py-2 bg-blue-200 text-blue-700  rounded-md hover:bg-blue-300'>Cancel</button>
                  <button className=' px-4 py-2 bg-blue-600 text-white  rounded-md hover:bg-blue-700'>Add CV/Resume</button>
                </div>
              </div>
            </div>
            <hr className='text-gray-100 w-full' />
